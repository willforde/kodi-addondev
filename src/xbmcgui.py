...
def hash_password(password):  # type: (str) -> str
...
class ListItem(dict):
    ...
    def getLabel(self):
        ...
        :rtype: str
        """
        return xbmc.ensure_native_str(self.get("label", u""))
    ...
    def getLabel2(self):
        ...
        :rtype: str
        """
        return xbmc.ensure_native_str(self.get("label2", u""))
    ...
    def setLabel(self, label):
        ...
        :type label: str or unicode
        """
        self["label"] = xbmc.ensure_unicode(label)
    ...
    def setLabel2(self, label2):
        ...
        """
        self["label2"] = xbmc.ensure_unicode(label2)
    ...
    def getPath(self):
        ...
        :rtype: str
        """
        return xbmc.ensure_native_str(self["path"])
    ...
    def setMimeType(self, mimetype):
        ...
        """
        self["mimetype"] = xbmc.ensure_unicode(mimetype)
...
class Dialog(object):
        ...
        try:
            ...
            if type == INPUT_PASSWORD:
                if option == PASSWORD_VERIFY:
                    ret = xbmc.session.input("Please enter password: ")
                    ...
                    while True:
                        ret = xbmc.session.input("Please enter password: ")
                        first_hash = hash_password(ret)
                        ret = xbmc.session.input("Please re-enter new password: ")
                ...
                ret = xbmc.session.input("Please enter text [%s]: ]" % default)
            else:
                ret = xbmc.session.input("Please enter text: ")
    ...
    def yesno(self, heading, line1, line2='', line3='', nolabel='', yeslabel='', autoclose=0):
        ...
        try:
            ret = xbmc.session.input("Please enter yes or no: ")
        except(KeyboardInterrupt, EOFError):
            return False
        else:
            ret = ret.lower()
    ...
    def ok(self, heading, line1, line2="", line3=""):
        ...
        print(line3)
        print("#############")
        xbmc.session.input("Please press enter to continue: ")
        return True
    ...
    def select(self, heading, list, autoclose=0, preselect=None, useDetails=False):
        ...
        try:
            ret = xbmc.session.input("Please enter a selection 'id': ")
...
class Control(object):
    ...
    def getPosition(self):
        ...
        """
        return xbmc.long_type(), xbmc.long_type()
