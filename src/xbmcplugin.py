...
def addSortMethod(handle, sortMethod, label2Mask=""):
    ...
    """
    xbmc.session.data.sortmethods.append(sortMethod)
...
def setContent(handle, content):
    ...
    """
    xbmc.session.data.contenttype = xbmc.ensure_unicode(content)
...
def setPluginCategory(handle, category):
    ...
    """
    xbmc.session.data.category = xbmc.ensure_unicode(category)
